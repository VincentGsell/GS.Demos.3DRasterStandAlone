...
Description :
- All-In-One unit 3d Software raster app.
  - All 3d calculus, and major "pipeline" step is present in only one unit (vertexshader, tesselator, raster preparation, fragment)
